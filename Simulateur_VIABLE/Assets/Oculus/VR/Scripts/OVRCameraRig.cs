...
public class OVRCameraRig : MonoBehaviour
{
    ...
    public virtual void EnsureGameObjectIntegrity()
    {
        ...
        if (_centerEyeCamera == null || _leftEyeCamera == null || _rightEyeCamera == null)
        {
            ...
            if (usePerEyeCameras) { _centerEyeCamera.gameObject.SetActive(false); } else { _leftEyeCamera.gameObject.SetActive(false); _rightEyeCamera.gameObject.SetActive(false); }
        }
