...
namespace Viable.VRNav {
    ...
    public class DroneMover_KeyboardMouse : DroneMover {
        ...
        protected override void UpdateInputs() {
            ...
            droneThruster.localEulerAngles = new Vector3(0f, 0f, maxThrusterAngle * rawInput_Left.y);
            droneJoystick.localEulerAngles = new Vector3(maxJoystickAngle * rawInput_Right.y, -90f, -maxJoystickAngle * rawInput_Right.x);
